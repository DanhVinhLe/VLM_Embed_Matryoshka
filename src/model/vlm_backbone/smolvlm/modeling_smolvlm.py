...
class SmolVLMModel(SmolVLMPreTrainedModel):
    ...
    def get_image_features(
        ...
        print(f"Shape of image_hidden_states before connector: {image_hidden_states.shape}")
        image_hidden_states = self.connector(image_hidden_states)
        print(f"Shape of image_hidden_states after connector: {image_hidden_states.shape}")
        return image_hidden_states
